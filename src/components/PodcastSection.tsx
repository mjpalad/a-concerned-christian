...
const platforms = [
  {
    name: "Spotify",
    href: "https://open.spotify.com/show/6aG7ZycK9JFQzDac81a50m",
    icon: () => (
  ...
  {
    name: "Apple Podcasts",
    href: "https://podcasts.apple.com/us/podcast/a-concerned-christian/id1891493687",
    icon: () => (
      <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" aria-hidden="true">
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/playlist?list=PLjKjsH4hjv8BIlXsgbvaOydFHdQ-9Uymy",
    icon: () => (
      <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current" aria-hidden="true">
